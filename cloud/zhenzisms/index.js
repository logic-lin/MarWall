...
const appId = '105244'
const appSecret = '580e74eb-0aa5-4566-8718-5996aba7bc3f'
...
exports.main = async (event, context) => {
  ...
  app.router('sendCode', async (ctx) => {
    ...
    const intervalTime = 60*1000//60 * 1000;//两条短信间隔时间(毫秒)，<=0 时无间隔
    ...
    ctx.body = new Promise(resolve => {
      rq({
        ...
        db.collection('sms-record').add({
          ...
          resolve({ code: 'success', msg: '发送验证码成功' });
        })
  ...
  app.router('validateCode', async (ctx) => {
    ...
    if (record.code != event.code){
      ctx.body = { code: 'code_error', msg: '验证码错误!' };
      return;
    }
    ctx.body = new Promise(resolve => {
